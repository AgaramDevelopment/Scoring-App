    ...
    if (sqlite3_open([dbPath UTF8String], &dataBase) == SQLITE_OK)
    {
        ...
        if(sqlite3_prepare(dataBase, stmt, -1, &statement, NULL)==SQLITE_OK)
        {
            while(sqlite3_step(statement)==SQLITE_ROW){
                ...
                record.wicket=[NSString stringWithUTF8String:(char *)sqlite3_column_text(statement, 15)];
                record.teamTotal=[NSString stringWithUTF8String:(char *)sqlite3_column_text(statement, 16)];
             //   record.wicketNo=[NSString stringWithUTF8String:(char *)sqlite3_column_text(statement, 30)];
                ...
                record.commentary=[NSString stringWithUTF8String:(char *)sqlite3_column_text(statement, 36)];
