...
-(IBAction)didClickResumeInnings:(id)sender
{
    ...
    else if(([self.lbl_NonStrikerName.text isEqualToString:@""] || self.lbl_NonStrikerName.text==nil) && ([self.lbl_BowlerName.text isEqualToString:@""] || self.lbl_BowlerName.text==nil))
    {
        [self ShowAlterView:@"Please Select NonStriker\nPlease Select Bowler"];
    }else if (([self.lbl_StrikerName.text isEqualToString:@""] || self.lbl_StrikerName.text==nil) && ([self.lbl_NonStrikerName.text isEqualToString:@""] || self.lbl_NonStrikerName.text==nil)){
        
        [self ShowAlterView:@"Please Select Striker\nPlease Select NonStriker" ];
        
    }    else if (([self.lbl_StrikerName.text isEqualToString:@""] || self.lbl_StrikerName.text==nil)  && ([self.lbl_BowlerName.text isEqualToString:@""] || self.lbl_BowlerName.text==nil)){
        
        [self ShowAlterView:@"Please Select Striker\nPlease Select Bowler" ];
        
    }
    
    else if (([self.lbl_StrikerName.text isEqualToString:@""] || self.lbl_StrikerName.text==nil)){
        [self ShowAlterView:@"Please Select Striker"];
