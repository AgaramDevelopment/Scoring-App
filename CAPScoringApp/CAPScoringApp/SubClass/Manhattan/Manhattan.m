...
-(void) BarChartMethodFirstInnigs2
{
   ...
   // _dataSource = objInnings2RunArray;
    ...
    _barChartView = [[MCBarChartView alloc] initWithFrame:CGRectMake(_barChartView.frame.origin.x+25,450, [UIScreen mainScreen].bounds.size.width, 260)];
...
//    }
   ...
   // _dataSource = objInnings3RunArray;
    ...
    _barChartView = [[MCBarChartView alloc] initWithFrame:CGRectMake(20,650, [UIScreen mainScreen].bounds.size.width, 260)];
...
-(void) BarChartMethodFirstInnigs4
{
   ...
   // }
    ...
    _barChartView = [[MCBarChartView alloc] initWithFrame:CGRectMake(43,850, [UIScreen mainScreen].bounds.size.width, 260)];
