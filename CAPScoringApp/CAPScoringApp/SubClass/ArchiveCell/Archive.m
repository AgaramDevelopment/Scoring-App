...
@property (nonatomic,strong)IBOutlet UIButton * Btn_swiferightside;
...
@synthesize lbl_teamname,lbl_cityname,lbl_groundName,Btn_swipebutton,lbl_date,lbl_displaydate;
- (void)awakeFromNib
{
    [super awakeFromNib];
...
{
    return CGRectGetWidth(self.frame) - CGRectGetMinX(self.button2.frame)+330;
}
