    ...
    if (sqlite3_open(dbPath, &dataBase) == SQLITE_OK)
    {
        ...
        if(sqlite3_prepare(dataBase, update_stmt, -1, &statement, NULL)==SQLITE_OK)
        {
            while(sqlite3_step(statement)==SQLITE_ROW){
                ...
                record.BATSMANNAME=[self getValueByNull:statement :0];
                record.BATTINGSTYLE=[self getValueByNull:statement :1];
                record.BOWLERCODE=[self getValueByNull:statement :2];
                record.BOWLERNAME=[self getValueByNull:statement :3];
                record.FIELDERNAME=[self getValueByNull:statement :4];
                record.RUNS=[self getValueByNull:statement :5];
                record.BALLS=[self getValueByNull:statement :6];
                record.MINS=[self getValueByNull:statement :7];
                record.ONES=[self getValueByNull:statement :8];
                record.TWOS=[self getValueByNull:statement :9];
                record.THREES=[self getValueByNull:statement :10];
                record.FOURS=[self getValueByNull:statement :11];
                record.SIXES=[self getValueByNull:statement :12];
                record.STRIKERATE=[self getValueByNull:statement :13];
                record.DOTBALLS=[self getValueByNull:statement :14];
                record.DOTBALLPERCENTAGE=[self getValueByNull:statement :15];
                record.RUNSPERSCORINGSHOTS=[self getValueByNull:statement :16];
                record.WICKETDESCRIPTION=[self getValueByNull:statement :17];
                record.WICKETNO=[self getValueByNull:statement :18];
                record.WICKETOVERNO=[self getValueByNull:statement :19];
                record.WICKETBALLNO=[self getValueByNull:statement :20];
                record.WICKETSCORE=[self getValueByNull:statement :21];
                record.WICKETTYPE=[self getValueByNull:statement :22];
                record.WICKETTYPEDESCRIPTION=[self getValueByNull:statement :23];
