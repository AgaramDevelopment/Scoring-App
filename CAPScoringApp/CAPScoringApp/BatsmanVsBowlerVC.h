...
@interface BatsmanVsBowlerVC : UIViewController
...
@property (weak, nonatomic) IBOutlet UIImageView *img_batsman_photo;
...
@property (strong, nonatomic) IBOutlet BatsmanVsBowlerTVCell *bats_vs_bow_tvcell;

@property (weak, nonatomic) IBOutlet UITableView *tableview_bowlers;
@property (weak, nonatomic) IBOutlet UIButton *btn_filter_ok;

@property (weak, nonatomic) IBOutlet UIView *view_filter;
@property (weak, nonatomic) IBOutlet UITableView *tableview_stricker;
@property (weak, nonatomic) IBOutlet UILabel *lbl_filter_stricker_name;
