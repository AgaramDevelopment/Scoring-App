...
@interface SpiderWagonRecords : NSObject
...
@property(strong,nonatomic)NSString *ISONSIDE;
@property(strong,nonatomic)NSString *SECTORREGIONCODE;
@property(strong,nonatomic)NSString *SECTORREGIONNAME;
...
@property(strong,nonatomic)NSString *SECTORREGION;
...
@property(strong,nonatomic)NSString *BALLNO1;
