...

{
    ...
    NSString *query=[NSString stringWithFormat:@"SELECT MATCHCODE,TEAMCODE,PLAYERCODE,RECORDSTATUS FROM MATCHTEAMPLAYERDETAILS WHERE MATCHCODE ='%@' AND PLAYERCODE ='%@' AND TEAMCODE ='%@'  AND RECORDSTATUS ='MSC001'",MATCHCODE,TEAMCODE,PLAYERCODE];
