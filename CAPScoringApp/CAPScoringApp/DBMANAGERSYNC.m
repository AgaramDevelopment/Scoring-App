...

{
    ...
    NSString *query=[NSString stringWithFormat:@"SELECT MATCHCODE,TEAMCODE,PLAYERCODE,RECORDSTATUS FROM MATCHTEAMPLAYERDETAILS WHERE MATCHCODE ='%@' AND PLAYERCODE ='%@' AND TEAMCODE ='%@'",MATCHCODE,PLAYERCODE,TEAMCODE];
