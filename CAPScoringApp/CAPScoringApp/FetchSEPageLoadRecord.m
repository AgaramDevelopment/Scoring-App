...
//        NONSTRIKERCODE = [NONSTRIKERCODE isEqual:WICKETPLAYER] ?@"":NONSTRIKERCODE;
    ...
    if(ISPARTIALOVER.intValue == 0){
        ...
        NSMutableArray *getBowlerBasedDetails = [db getTOTALBALLSBOWL :COMPETITIONCODE MATCHCODE:MATCHCODE INNINGSNO:INNINGSNO BATTINGTEAMCODE:BATTINGTEAMCODE BOWLERCODE:BOWLERCODE:T_TOTALRUNS];
