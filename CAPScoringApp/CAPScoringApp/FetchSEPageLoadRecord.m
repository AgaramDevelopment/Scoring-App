...
-(void) fetchSEPageLoadDetails :(NSString*) COMPETITIONCODE :(NSString *)MATCHCODE{
   ...
   // NSNumber *TARGETRUNS;
    ...
    getBowlingTeamPlayers = [DBManager GETBOWLINGTEAMPLAYERS:penaltyBowlerCode MATCHCODE:MATCHCODE BOWLINGTEAMCODE:BOWLINGTEAMCODE COMPETITIONCODE:COMPETITIONCODE BATTINGTEAMCODE:BATTINGTEAMCODE INNINGSNO:INNINGSNO ISOVERCOMPLETE:isOverComplete BATTEAMOVERS:batTeamOver];
